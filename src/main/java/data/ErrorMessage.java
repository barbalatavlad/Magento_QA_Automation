...
public class ErrorMessage {
    public static final String LOGIN_AND_PASSWORD_ERROR_MESSAGE = "A login and a password are required.";
    public static final String INCORRECT_EXPECTED_ERROR = "The expected error message is incorrect";
